        ...
        <c:choose>
            <c:when test="${not empty cancion}">
                ...
                <div class="button-container">
                    ...
                    <a class="btn btn-edit" href="/formulario/editar/${idCancion}">Editar Canción</a>
                    <!-- Botón para volver -->
...
<!--  
    ...
    <p>Fecha de Creación: ${cancion.createdAt}</p>
    <p>Fecha de Actualización: ${cancion.updatedAt}</p>
